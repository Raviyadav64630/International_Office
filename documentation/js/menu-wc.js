                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-7aee52dde475535dd198ddf01fed4680"' : 'data-target="#xs-components-links-module-AppModule-7aee52dde475535dd198ddf01fed4680"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-7aee52dde475535dd198ddf01fed4680"' :
                                            'id="xs-components-links-module-AppModule-7aee52dde475535dd198ddf01fed4680"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/InternationalComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">InternationalComponent</a>
                                            </li>
                                            <li class="link">
